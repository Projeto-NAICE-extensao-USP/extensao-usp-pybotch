...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Início — Extensão USP São Carlos" },
      {
        name: "description",
        content:
      ...
      <section className="relative overflow-hidden">
        <div className="absolute inset-0">
          ...
          <div
            ...
            style={{ background: "var(--gradient-hero)", opacity: 0.88 }}
          />
        </div>
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-24 sm:py-32 lg:py-40">
          <div className="max-w-3xl mx-auto text-center text-primary-foreground">
            ...
            <h1 className="mt-6 font-display text-4xl sm:text-5xl lg:text-6xl font-bold leading-[1.05]">
              ...
              <span className="text-[oklch(0.82_0.15_55)]">Scratch</span> e{" "}
          ...
          {[
            {
              ...
              desc: "Aulas estruturadas, com objetivos pedagógicos claros.",
            },
            {
              icon: Download,
              title: "Tudo para baixar",
              desc: "Códigos, slides e guias em PDF, .py, .sb3, .ino e mais.",
            },
            {
              icon: Users,
              title: "Feito por estudantes",
              desc: "Universitários da USP em parceria com professores das escolas.",
            },
          ].map((h) => (
            <div
              key={h.title}
            ...
            >
              ...
              <h3 className="mt-4 font-display font-semibold text-foreground">{h.title}</h3>
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {disciplineCards.map((d) => (
            ...
            >
              ...
              <div className="p-6">
                <h3 className={`font-display text-2xl font-bold ${d.text}`}>{d.title}</h3>
          ...
          <div className="grid gap-8 md:grid-cols-[1fr_auto] md:items-center">
            <div>
              ...
              <p className="mt-3 text-muted-foreground max-w-2xl">
                Conte para a gente sobre sua escola e como podemos colaborar — desde
                aplicar os materiais até trocar experiências com a equipe.
              </p>
            </div>
            <Link
              to="/contato"
